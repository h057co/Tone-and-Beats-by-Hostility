...
Este proyecto usa los siguientes recursos gráficos:
...
- `HOSTBLANCO.ico` - Icono de la aplicación

## Uso

Los logos se cargan dinámicamente según el tema seleccionado:
- Tema Dark: HOST_BLANCO.png
